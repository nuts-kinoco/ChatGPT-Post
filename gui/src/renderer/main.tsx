...
function Popup({ state, now, choose, showNotice, newRequest }: { state: BridgeGuiState; now: number; choose: (id: string) => void; showNotice: (notice: string) => void; newRequest: () => void }) {
